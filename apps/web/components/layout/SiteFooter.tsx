    ...
    <footer className="bg-primary text-primary-foreground relative overflow-hidden">
      ...
      <div className="container relative z-10 py-8 sm:py-12 md:py-16 px-4 sm:px-6">
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 sm:gap-8 mb-6 sm:mb-8">
          ...
          <div className="space-y-4">
            <div>
              <h3 className="text-xl sm:text-2xl font-bold mb-2">
                <span className="text-primary-foreground">Solucion De</span>
                <span className="text-orange-500"> Salud</span>
              </h3>
              <p className="text-xs sm:text-sm text-primary-foreground/90 leading-relaxed">
                Solucion De Salud es la única plataforma web 100% gratuita que te permite comparar, cotizar y solicitar planes y seguros de salud de todas las Isapres y aseguradoras de Chile.
              </p>
            </div>
          ...
          {/* Contacto */}
          <div className="space-y-4">
            <h4 className="text-lg font-bold uppercase">SOLUCION DE SALUD</h4>
        ...
        <div className="border-t border-primary-foreground/20 pt-6 mt-8">
          <div className="flex flex-col md:flex-row justify-between items-center gap-4 text-sm">
            <p className="text-primary-foreground/80">
              2024 Solucion De Salud © Derechos reservados
            </p>
